...
mod test {
    use crate::algo::{
        bubble_sort::bubble_sort, bucket_sort::bucket_sort, count_sort::count_sort,
        heap_sort::heap_sort, insert_sort::insert_sort, merge_sort::merge_sort,
        quick_sort::quick_sort, radix_sort::radix_sort, select_sort::select_sort,
